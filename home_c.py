...
"")
        ...
        self.spotted_vehicles = QtWidgets.QWidget()
        self.spotted_vehicles.setObjectName("spotted_vehicles")
        self.gridLayout_16 = QtWidgets.QGridLayout(self.spotted_vehicles)
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.add_remove_frame_3 = QtWidgets.QFrame(self.spotted_vehicles)
...
"")
        ...
        self.stackedWidget.addWidget(self.spotted_vehicles)
...
"")
        ...
        self.car_deatils_label.setGeometry(QtCore.QRect(20, 45, 141, 19))
...
"}")
        ...
        self.view_watchlist = QtWidgets.QPushButton(self.add_remove_frame)
        self.view_watchlist.setGeometry(QtCore.QRect(530, 10, 161, 23))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.view_watchlist.setFont(font)
        self.view_watchlist.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.view_watchlist.setStyleSheet("QPushButton{\n"
...
"border-radius:5%;\n"
"}")
        self.view_watchlist.setObjectName("view_watchlist")
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(self.watchlist)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frame_17 = QtWidgets.QFrame(self.watchlist)
        self.frame_17.setMaximumSize(QtCore.QSize(16777215, 100))
        self.frame_17.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.98, y1:0.471364, x2:1, y2:0.472, stop:1 rgba(0, 0, 0, 18));\n"
"border-radius:10%;\n"
"")
        ...
        self.frame_18 = QtWidgets.QFrame(self.watchlist)
        self.frame_18.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.98, y1:0.471364, x2:1, y2:0.472, stop:1 rgba(0, 0, 0, 18));\n"
"")
        ...
        self.download_watchlist = QtWidgets.QPushButton(self.frame_18)
        self.download_watchlist.setMaximumSize(QtCore.QSize(85, 16777215))
        self.download_watchlist.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.download_watchlist.setStyleSheet("QPushButton {\n"
"    border: 2px solid rgb(51,51,51);\n"
"    border-radius: 5px;    \n"
"    color:rgb(255,255,255);\n"
"    background-color: rgb(51,51,51);\n"
...
"    background-color: rgb(112,112,112);\n"
"}")
        self.download_watchlist.setObjectName("download_watchlist")
        self.verticalLayout_3.addWidget(self.download_watchlist)
...
"}")
        ...
        self.btn_search.setGeometry(QtCore.QRect(570, 50, 80, 30))
...
"")
        ...
        self.bn_android_contact_edit_3.setMinimumSize(QtCore.QSize(120, 25))
        self.bn_android_contact_edit_3.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
...
"}")
        ...
        self.gridLayout_10.addWidget(self.bn_android_contact_edit_3, 2, 1, 1, 1)
...
"color: rgb(255, 255, 240);")
        ...
        self.gridLayout_10.addWidget(self.system_users_table, 1, 0, 1, 3)
...
"background:transparent;")
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(304, 20, 101, 23))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Vehicle detailed are fetched from the national registered vehicled database"))
        ...
        self.view_watchlist.setText(_translate("MainWindow", "➕ Click to view watchlist"))
        self.label_18.setText(_translate("MainWindow", "WATCHLIST 👁"))
        self.tableWidget.setToolTip(_translate("MainWindow", "click to download watchlist"))
        self.download_watchlist.setText(_translate("MainWindow", "DOWNLOAD ⬇️"))
        ...
        self.bn_android_contact_edit_3.setText(_translate("MainWindow", "DOWNLOAD ⬇️"))
